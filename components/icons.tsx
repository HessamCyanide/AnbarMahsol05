...
export const DollarIcon = ({ className = "w-8 h-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.825-1.106-2.156 0-2.981.544-.406 1.253-.624 2.003-.624.625 0 1.258.174 1.834.527m6.25 1.628c.36.27.36.756 0 1.026l-2.812 2.11c-.36.27-.36.756 0 1.026l2.812 2.11c.36.27.36.756 0 1.026l-2.812 2.11c-.36.27-.36.756 0 1.026l2.812 2.11c.36.27.36.756 0 1.026L18 21m-12-2.818c-.36.27-.36.756 0 1.026l2.812 2.11c.36.27.36.756 0 1.026l-2.812 2.11c-.36.27-.36.756 0 1.026l2.812 2.11c.36.27.36.756 0 1.026L6 21" />
    </svg>
);
